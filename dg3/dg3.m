function [finalgroups, used_FEs] = dg3( fname, func_num, lb, ub, dim, flag)
%OFFLINEGROUPING 此处显示有关此函数的摘要
%   此处显示详细说明
groups = 1:dim;
groups = num2cell(groups);

[lbFit, lbG, lbH] = feval(fname, lb, func_num);
lbPhi = [lbG, lbH];
if strcmp(flag, 'phi')
    lbFit = lbPhi;
end
...
while group_num>0
        ...
        [relation, FEs] = identify(fname, func_num, groups, src_index, des_index, relation, lb, ub, lbFit, flag);
